...
export const productRelationships = [
  { source: 'Laptop', target: 'Mouse', strength: 0.85 },
  { source: 'Laptop', target: 'Laptop Bag', strength: 0.72 },
  { source: 'Laptop', target: 'USB Hub', strength: 0.58 },
  { source: 'Phone', target: 'Phone Case', strength: 0.92 },
  { source: 'Phone', target: 'Screen Guard', strength: 0.88 },
  { source: 'Phone', target: 'Earbuds', strength: 0.65 },
  { source: 'Shirt', target: 'Belt', strength: 0.78 },
  { source: 'Shirt', target: 'Trousers', strength: 0.82 },
  { source: 'Jeans', target: 'T-Shirt', strength: 0.75 },
  { source: 'Bread', target: 'Butter', strength: 0.90 },
  { source: 'Bread', target: 'Jam', strength: 0.68 },
  { source: 'Milk', target: 'Cereal', strength: 0.72 },
  { source: 'Shampoo', target: 'Conditioner', strength: 0.88 },
  { source: 'Face Wash', target: 'Moisturizer', strength: 0.76 },
  { source: 'Frame', target: 'Lens', strength: 0.95 },
  { source: 'Frame', target: 'Case', strength: 0.70 },
  { source: 'Sunglasses', target: 'Cleaning Kit', strength: 0.62 },
]
